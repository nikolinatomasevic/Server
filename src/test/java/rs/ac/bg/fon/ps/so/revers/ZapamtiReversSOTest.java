...
class ZapamtiReversSOTest extends AbstractSOTest {
	...
	@Test
	void testPreconditionDatumIzdavanjaNull() {
		revers.setDatumIzdavanja(null);

		RadnoMesto radnoMesto = new RadnoMesto(2l, "Sef gradilista");
		Radnik radnik = new Radnik(1l, "Marko", "Markovic", "0637792469", "marko.markovic@ps.fon.bg.ac.rs", radnoMesto);
		revers.setRadnik(radnik);

		MasinaIliAlat masinaIliAlat = new MasinaIliAlat(1l, "Brusilica", 23, 0);
		StavkaReversa stavkaReversa = new StavkaReversa(revers, 1, 8, null, 0, masinaIliAlat);
		List<StavkaReversa> stavke = new LinkedList<StavkaReversa>();
		stavke.add(stavkaReversa);
		revers.setStavke(stavke);

		assertThrows(java.lang.Exception.class, () -> so.precondition(revers));
	}

	@Test
	void testPreconditionRadnikNull() {
		try {
	...
	@Test
	void testPreconditionNemaStavki() {
		try {
			Date datumIzdavanja = new SimpleDateFormat("dd.MM.yyyy.").parse("8.8.2022.");
			revers.setDatumIzdavanja(datumIzdavanja);
	...
	@Test
	void testPreconditionReversStavkeReversaNull() {
		try {
			Date datumIzdavanja = new SimpleDateFormat("dd.MM.yyyy.").parse("8.8.2022.");
			revers.setDatumIzdavanja(datumIzdavanja);
			...
			MasinaIliAlat masinaIliAlat = new MasinaIliAlat(1l, "Brusilica", 23, 0);
			StavkaReversa stavkaReversa = new StavkaReversa(null, 1, 8, null, 0, masinaIliAlat);
			List<StavkaReversa> stavke = new LinkedList<StavkaReversa>();
			stavke.add(stavkaReversa);
			revers.setStavke(stavke);
	...
	@Test
	void testPreconditionRedniBrojStavkeNull() {
		try {
			Date datumIzdavanja = new SimpleDateFormat("dd.MM.yyyy.").parse("8.8.2022.");
			revers.setDatumIzdavanja(datumIzdavanja);
			...
			MasinaIliAlat masinaIliAlat = new MasinaIliAlat(1l, "Brusilica", 23, 0);
			StavkaReversa stavkaReversa = new StavkaReversa(revers, null, 8, null, 0, masinaIliAlat);
			List<StavkaReversa> stavke = new LinkedList<StavkaReversa>();
			stavke.add(stavkaReversa);
			revers.setStavke(stavke);
	...
	@Test
	void testPreconditionZaduzenaKolicinaNull() {
		try {
			Date datumIzdavanja = new SimpleDateFormat("dd.MM.yyyy.").parse("8.8.2022.");
			revers.setDatumIzdavanja(datumIzdavanja);
			...
			MasinaIliAlat masinaIliAlat = new MasinaIliAlat(1l, "Brusilica", 23, 0);
			StavkaReversa stavkaReversa = new StavkaReversa(revers, 1, null, null, 0, masinaIliAlat);
			List<StavkaReversa> stavke = new LinkedList<StavkaReversa>();
			stavke.add(stavkaReversa);
			revers.setStavke(stavke);
	...
	@Test
	void testPreconditionZaduzenaKolicinaManjaOdNule() {
		try {
			Date datumIzdavanja = new SimpleDateFormat("dd.MM.yyyy.").parse("8.8.2022.");
			revers.setDatumIzdavanja(datumIzdavanja);
	...
	@Test
	void testPreconditionMasinaIliAlatNull() {
		try {
			Date datumIzdavanja = new SimpleDateFormat("dd.MM.yyyy.").parse("8.8.2022.");
			revers.setDatumIzdavanja(datumIzdavanja);
			...
			StavkaReversa stavkaReversa = new StavkaReversa(revers, 1, 5, null, 0, null);
			List<StavkaReversa> stavke = new LinkedList<StavkaReversa>();
			stavke.add(stavkaReversa);
			revers.setStavke(stavke);
